/*
 * @Author: BDFD
 * @Date: 2022-06-22 11:27:51
 * @LastEditTime: 2022-06-22 11:27:56
 * @LastEditors: BDFD
 * @Description:
 * @FilePath: \blob-carousel-for-the-planet\anime.js
 */
/*
 * anime.js v3.0.1
		...
		return function (n) {
			return 0 === n || 1 === n
				...
				: -r *
						Math.pow(2, 10 * (n - 1)) *
						Math.sin(
							((n - 1 - (t / (2 * Math.PI)) * Math.asin(1 / r)) * (2 * Math.PI)) / t
						);
		};
	}
	function l(n) {
	...
	function en(r) {
		...
		function D(n) {
			...
			(x.progress = a((d / e) * 100, 0, 100)),
				...
				d > r && d < l
					? (x.changeBegan ||
							((x.changeBegan = !0), (x.changeCompleted = !1), B("changeBegin")),
					  B("change"),
					  I(d))
					: x.changeBegan &&
					  ((x.changeCompleted = !0), (x.changeBegan = !1), B("changeComplete")),
		...
		return (
			...
			(x.play = function () {
				x.paused &&
					(x.completed && x.reset(), (x.paused = !1), U.push(x), O(), K || nn());
			}),
			(x.reverse = function () {
				k(), O();
			}),
